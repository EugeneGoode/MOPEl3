...
class Lab3:
    def __init__(self):
        ...
        self.x_average_max = (self.x1_max + self.x2_max + self.x3_max)/3
    ...
    def generate_matrix(self):
        ...
        print(
            "Дані варіанту 207 : y_max = {}  y_min = {}  x1_min = {}  x1_max = {}  x2_min = {}  x2_max = {}  x3_min = {}  x3_max = {}".format(
    ...
    def cochran_criteria(self, m, N, y_table):
        ...
        q = 1-p
        q1 = q/f1
        gt = f.ppf(q=1 - q1, dfn=f2, dfd=(f1 - 1) * f2)
    ...
    def student_criteria(self, m, N, y_table, factors_table):
        ...
        p = 0.95
        q = 0.05
        student = partial(t.ppf, q)
        t_student = student(df=f3)
        self.importance = [True if el > t_student else False for el in list(t_i)]
        # print result data
        print("f3 = {} q = {} tтабл = {}".format(f3, q, t_student))
